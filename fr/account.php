...
?>
<div class="glob">
    <h1>Connecté en tant que: <?php echo $_SESSION['username'] ?></h1>
</div>
<div class="loged">
    <h2>Votre email: <?php echo $_SESSION['mail'] ?></h2>
    <h2>Votre mot de passe: <?php echo $_SESSION['password'] ?></h2>
        ...
        while ($donnees = $reponse->fetch())
        {
            ...
            ?>
                <div class="response">
                    ...
                    <form action="account.php" method="post" onSubmit="return confirm('Are you sure you want to proceed?');">
                        <button name="del" value="<?php echo $donnees['id'] ?>">Supprimer</button>
                    </form>
                    <form action="modify.php" method="post">
                        <button name="mod" value="<?php echo $donnees['id'] ?>">Modifier</button>
                    </form>
                </div>
            <?php
            }
            ...
            <div class="idea<?php echo $donnees['categorie'] ?>">
                ...
                <table border=0 style="table-layout: fixed; width:100%" id="core">
                    <td width="120px">
                        Réponses: <?php echo $replies->fetchColumn() ?>
